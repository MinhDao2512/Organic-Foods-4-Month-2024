        ...
        <div class="row g-5">
            <div class="col-lg-3 col-md-6">
                <div class="footer-item">
                    <h4 class="text-light mb-3">Tại sao khách hàng lựa chọn chúng tôi?</h4>
                    <p class="mb-4">Với sứ mệnh cung cấp những trái cây, rau củ tươi ngon và lành mạnh, chúng tôi hy vọng mang đến sự hài lòng và niềm vui cho khách hàng của mình.</p>
                    <a href="" class="btn border-secondary py-2 px-4 rounded-pill text-primary">Đọc thêm</a>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="d-flex flex-column text-start footer-item">
                    <h4 class="text-light mb-3">Thông tin chi tiết</h4>
                    <a class="btn-link" href="">Liên hệ</a>
                    <a class="btn-link" href="">Chính sách bảo mật</a>
                    <a class="btn-link" href="">Hỏi đáp</a>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="d-flex flex-column text-start footer-item">
                    ...
                    <a class="btn-link" href="">Giỏ hàng của bạn</a>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="footer-item">
                    ...
                    <p>Địa chỉ: 97 Man Thiện, TP. Thủ Đức, TP. HCM, Viet Nam</p>
                    <p>Email: vusonghuong02@gmail.com</p>
                    <p>Phone: 0392722286
